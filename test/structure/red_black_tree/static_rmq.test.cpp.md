...
data:
  ...
  bundledCode: "#line 1 \"test/structure/red_black_tree/static_rmq.test.cpp\"\n#define\
    ...
    \ {\n            *it++ = g(p->prd, lazy);\n            return;\n        }\n  \
    \      lazy = h(lazy, p->lazy);\n        dfs(p->l, lazy, it);\n        dfs(p->r,\
    \ lazy, it);\n    }\n};\n\n#line 4 \"test/structure/red_black_tree/static_rmq.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/structure/red_black_tree/static_rmq.test.cpp
layout: document
redirect_from:
- /verify/test/structure/red_black_tree/static_rmq.test.cpp
- /verify/test/structure/red_black_tree/static_rmq.test.cpp.html
