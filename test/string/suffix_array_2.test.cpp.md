...
data:
  ...
  bundledCode: "#line 1 \"test/string/suffix_array_2.test.cpp\"\n#define PROBLEM \"\
    ...
    \n      if(h > 0) h--;\n      for(; j + h < n && i + h < n; h++) {\n        if(s[j+h]\
    \ != s[i+h]) break;\n      }\n\n      lcp[rank_lcp[i] - 1] = h;\n    }\n\n   \
    \ return lcp;\n  }\n\n};\n#line 4 \"test/string/suffix_array_2.test.cpp\"\n\r\n\
  ...
  verifiedWith: []
documentation_of: test/string/suffix_array_2.test.cpp
layout: document
redirect_from:
- /verify/test/string/suffix_array_2.test.cpp
- /verify/test/string/suffix_array_2.test.cpp.html
