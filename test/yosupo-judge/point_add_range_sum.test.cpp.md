...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-judge/point_add_range_sum.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n\n#line 1 \"\
    lib/template.cpp\"\n\n\n\n#include <bits/stdc++.h>\n\nusing namespace std;\n\n\
    ...
    * @brief \u30BB\u30B0\u30E1\u30F3\u30C8\u6728\n* @author habara-k, Md\n* @date\
    ...
    \ 4 \"test/yosupo-judge/point_add_range_sum.test.cpp\"\n\nint main() {\n    int\
  ...
  verifiedWith: []
documentation_of: test/yosupo-judge/point_add_range_sum.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo-judge/point_add_range_sum.test.cpp
- /verify/test/yosupo-judge/point_add_range_sum.test.cpp.html
